                ...
                <form method="POST" action="{{ route('register') }}">
                    ...
                    <div class="input-group mb-3" hidden>
                        <input id="role" type="text" class="form-control @error('name') is-invalid @enderror"
                            name="role" value="User" required autocomplete="role" autofocus placeholder="role">
                        <div class="input-group-append">
                            <div class="input-group-text">
                                <span class="fas fa-user"></span>
                            </div>
                    ...
                    <div class="input-group mb-3">
                        <input id="gendre" type="text" class="form-control @error('gendre') is-invalid @enderror"
                            name="gendre" value="{{ old('genre') }}" required autocomplete="genre" autofocus
                            placeholder="genre">
                        <div class="input-group-append">
                            <div class="input-group-text">
                                <span class="fas fa-user"></span>
                    ...
                    <div class="form-group mb-3">
                        <label>Prodi</label>
                        <select class="form-control" name="studi_id">
